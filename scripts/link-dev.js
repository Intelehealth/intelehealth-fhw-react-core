...
console.log('🔗 Setting up ih-hw-core for local development...');

// Check if we're in the right directory
if (!fs.existsSync('package.json') || !fs.existsSync('src')) {
  console.error(
    '❌ Error: Please run this script from the ih-hw-core root directory'
  );
  process.exit(1);
}
...
try {
  ...
  console.log('2. Run: npm link @intelehealth/ih-hw-core');
  console.log('3. Start development:');
  console.log('   - Library: npm run dev (in ih-hw-core directory)');
  console.log('   - Your app: npm start (in your app directory)');
  console.log('');
  console.log('🔄 To unlink later:');
  console.log('   - From your app: npm unlink @intelehealth/ih-hw-core');
